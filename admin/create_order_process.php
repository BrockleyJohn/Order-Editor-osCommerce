...
*/
  ...
  require('includes/application_top.php');
   ...
   if (!tep_db_num_rows(tep_db_query("SHOW COLUMNS FROM orders LIKE 'customer_service_id'"))) {
    tep_db_query ("alter table orders add customer_service_id varchar(15) NULL");
   }
  ...
  $format_id = co_get_address_format_id($country_id);
  $size = "1";
...
// TABLES: countries;
  function co_get_address_format_id($country_id) {
