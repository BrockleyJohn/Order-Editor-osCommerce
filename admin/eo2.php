              ...
              <tr>
                <td valign="top" width="100%">
                  ...
                  <div>
                      ...
                      tep_href_link('edit_orders_add_product.php', 'oID=' . $oID . '&step=1'); ?>" target="addProducts" onClick="openWindow('<?php echo tep_href_link('edit_orders_add_product.php', 'oID=' . $oID . '&step=1'); ?>','addProducts');return false"><?php echo tep_image_button('button_add_article.gif', TEXT_ADD_NEW_PRODUCT); 
/*
                      echo '<a href="' . tep_draw_button(TEXT_ADD_NEW_PRODUCT, "plus", null, null, array( array('newwindow' => "addProducts", onClick => "openWindow('<?php echo tep_href_link('edit_orders_add_product.php', 'oID=' . $oID . '&step=1'))' => true));
  */                    
