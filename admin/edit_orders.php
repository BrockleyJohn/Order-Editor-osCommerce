...
<!-- body_text //-->
    ...
    <?php 
//    echo "TAX CLASS: " . $GLOBALS[$shipping_modules]->tax_class . "<br />";
/*
    echo $module->class . "<br />";
    echo $module->check . "<br />";
    echo $tax;
    echo tep_get_tax_rate($GLOBALS[$module]->tax_class, $order->delivery['country']['id'], $order->delivery['zone_id']); ":" . "<br  />";
    echo tep_get_tax_rate(1, $order->delivery['country']['id'], $order->delivery['zone_id']); ":" . "<br />";
 print_R ($GLOBALS);
    ...
    <div id="header">
      <p id="headerTitle" class="pageHeading"><?php echo sprintf(HEADING_TITLE, $oID, tep_datetime_short($order->info['date_purchased'])); ?></p>
        <ul>
          ...
          <li><?php echo '<a href="' . tep_href_link(FILENAME_ORDERS, tep_get_all_get_params(array('oID', 'action')) . 'oID=' . $oID . '&action=edit') . '">' . tep_image_button('button_details.gif', IMAGE_EDIT) . '</a>'; ?></li>
          <li><?php echo '<a href="' . tep_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $oID) . '" TARGET="_blank">' . tep_image_button('button_invoice.gif', IMAGE_ORDERS_INVOICE) . '</a>'; ?></li>
          <li><?php echo '<a href="' . tep_href_link(FILENAME_ORDERS_PACKINGSLIP, 'oID=' . $oID) . '" TARGET="_blank">' . tep_image_button('button_packingslip.gif', IMAGE_ORDERS_PACKINGSLIP) . '</a>'; ?></li>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="2" style="border: 1px solid #C9C9C9;">
            ...
            <tr class="dataTableRow">
              ...
              <td valign="top" class="dataTableContent"><span id="customerStateMenu">
                <?php echo tep_draw_pull_down_menu('update_customer_zone_id', tep_get_country_zones($order->customer['country_id']), $order->customer['zone_id'], 'style="width: 200px;" onChange="updateOrdersField(\'customers_state\', this.options[this.selectedIndex].text);"');?>
              ...
              <tr id="shippingAddressEntry">
                ...
                <table width="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr class="dataTableRow">
                    ...
                    <?php echo tep_draw_pull_down_menu('update_delivery_zone_id', tep_get_country_zones($order->delivery['country_id']), $order->delivery['zone_id'], 'style="width: 200px;" onChange="updateShippingZone(\'delivery_state\', this.options[this.selectedIndex].text);"'); ?>
              ...
              <tr id="billingAddressEntry">
                ...
                <table width="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr class="dataTableRow">
                    ...
                    <?php echo tep_draw_pull_down_menu('update_billing_zone_id', tep_get_country_zones($order->billing['country_id']), $order->billing['zone_id'], 'style="width: 200px;" onChange="updateOrdersField(\'billing_state\', this.options[this.selectedIndex].text);"');?>
                  ...
                  <tr class="dataTableRow">
                    ...
                    <td class="dataTableContent" valign="middle" align="right" nowrap><?php echo ENTRY_COUNTRY; ?></td>
                    <td class="dataTableContent" valign="top">
                    <?php echo tep_draw_pull_down_menu('update_billing_country_id', tep_get_countries(), $order->billing['country_id'], 'style="width: 200px;" onchange="update_zone(\'update_billing_country_id\', \'update_billing_zone_id\', \'billingStateInput\', \'billingStateMenu\'); updateOrdersField(\'billing_country\', this.options[this.selectedIndex].text);"');?>
                    </td>
                  </tr>
                </table>
                </td>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" width="100%">
                  <br>
                  <div>
                      <a href="<?php echo tep_href_link(FILENAME_ORDERS_EDIT_ADD_PRODUCT, 'oID=' . $oID . '&step=1'); ?>" target="addProducts" onClick="openWindow('<?php echo tep_href_link(FILENAME_ORDERS_EDIT_ADD_PRODUCT, 'oID=' . $oID . '&step=1'); ?>','addProducts');return false"><?php echo tep_image_button('button_add_article.gif', TEXT_ADD_NEW_PRODUCT); ?></a><input type="hidden" name="subaction" value="">
                  </div>
                  <br>
                </td>
        <!-- order_totals bof //-->
	...
	<?php /*
               <!-- paypal bof jm //-->
                <table border="0" width="550" cellspacing="0" cellpadding="2" style="border: 1px solid #C9C9C9;">
                  <tr class="dataTableHeadingRow">
                    <td class="dataTableHeadingContent" colspan="3">Paypal comisión</td>
                  </tr>
                  <tr class="dataTableRow">
                <td class="dataTableHeadingContent"><a href="" target="addProducts" onClick="document.getElementById('jm').value = 112"><?php echo tep_image_button('button_calcula.gif', "Agregar tarifa"); ?></a></td>
                  </tr>
                  <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent" colspan="3"><?php echo '4% s/ ' . number_format($subtotalpedido) . ' = ' . $subtotalpedido *.04; ?></td>
                  </tr>
                </table>
                <!-- paypal eof //-->
*/ ?>
